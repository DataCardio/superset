        ...
        [
          {
            ...
            config: {
              ...
              isFloat: true,
              renderTrigger: true,
              description: t('Values below this threshold get the "Below" color'),
            },
          },
          {
            name: 'threshold_high',
            config: {
              ...
              isFloat: true,
              renderTrigger: true,
              description: t('Values above this threshold get the "Above" color'),
            },
          },
          {
            name: 'color_below_low',
            config: {
              type: 'ColorPickerControl',
              label: t('Color Below Lower Threshold'),
              renderTrigger: true,
              description: t('Color for values below the lower threshold'),
            },
          },
          {
            name: 'color_between',
            config: {
              type: 'ColorPickerControl',
              label: t('Color Between Thresholds'),
              renderTrigger: true,
              description: t('Color for values between thresholds'),
            },
          },
          {
            name: 'color_above_high',
            config: {
              type: 'ColorPickerControl',
              label: t('Color Above Upper Threshold'),
              renderTrigger: true,
              description: t('Color for values above the upper threshold'),
            },
          },
        ],
        ...showValueSection,
