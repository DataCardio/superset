...
export default class EchartsTimeseriesBarThresholdChartPlugin extends EchartsChartPlugin<
  EchartsTimeseriesFormData,
  EchartsTimeseriesChartProps
> {
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: t(
          'Bar Charts with dynamic coloring based on value thresholds.',
        ),
        exampleGallery: [
          { url: example1 },
          { url: example2 },
        ...
        name: t('Bar Chart (with dynamics)'),
        tags: [
          t('ECharts'),
          t('Predictive'),
