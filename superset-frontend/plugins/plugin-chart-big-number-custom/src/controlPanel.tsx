...
} from '../../plugin-chart-echarts/src/BigNumber/sharedControls';
        ...
        [
          {
            ...
            config: {
              ...
              visibility(props) {
                ...
                [
          {
            name: 'is_percentage_metric',
            config: {
              type: 'CheckboxControl',
              label: t('Percentage Points'),
              renderTrigger: true,
              default: false,
              description: t(
                'If checked, the dynamics is calculated in percentage points instead of relative percent.',
              ),
            },
          },
        ],
